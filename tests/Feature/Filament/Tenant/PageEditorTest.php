...
describe('mounting, selection and the inspector', function (): void {
...
describe('structural verbs', function (): void {
...
describe('committing and saving the draft', function (): void {
...
describe('page settings', function (): void {
...
describe('selection guards, duplication and reordering', function (): void {
...
describe('undo and redo', function (): void {
 ...
 */
describe('surviving a reload', function (): void {
 ...
 */
describe('a chat-staged style across a reload', function (): void {
 ...
 */
describe('version history', function (): void {
...
describe('the block library', function (): void {
...
describe('the page-level header actions', function (): void {
...
describe('site chrome in the inspector', function (): void {
 ...
 */
describe('the AI chat: landing a turn', function (): void {
 ...
 */
describe('retrying a failed turn', function (): void {
 ...
 */
describe('naming and publishing a version', function (): void {
...
describe('actions the canvas mounts', function (): void {
 ...
 */
describe('reverting one assistant turn', function (): void {
 ...
 * that exist nowhere.
 */
describe('repainting a canvas the turn painted', function (): void {
 ...
 */
describe('the selection that rides with a turn', function (): void {
 ...
 */
describe('cycling a block through its layouts', function (): void {
...
describe('the composer mode, and the transcript', function (): void {
 ...
 */
describe('pointing at what the answer changed', function (): void {
 ...
 */
describe('committing before the assistant reads the page', function (): void {
 ...
 */
describe('the asynchronous contract of a turn', function (): void {
    /*
 ...
 */
describe('design authority from the chat', function (): void {
 ...
 */
describe('the assistant reaching site chrome', function (): void {
 ...
 */
describe('composer attachments', function (): void {
