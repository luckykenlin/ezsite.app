...
return [
    ...
    'models' => [
         ...
         *
         * @see UUIDGenerator
         * @see UniqueIdentifierGenerators\ULIDGenerator
         * @see UniqueIdentifierGenerators\UUIDv7Generator
    ...
    'identification' => [
         ...
         */
        'central_domains' => [
            str(config()->string('app.url'))->after('://')->before('/')->before(':')->toString(),
        ],
         ...
         */
        'default_middleware' => InitializeTenancyByDomainOrSubdomain::class,
    ...
    'bootstrappers' => [
        ...
        // Bootstrappers\DatabaseTenancyBootstrapper::class, // Not used: this app uses single-database tenancy via Postgres RLS instead
     ...
     */
    'seeder_parameters' => [
        '--class' => DatabaseSeeder::class, // root seeder class
        // '--force' => true,
    ],
];
