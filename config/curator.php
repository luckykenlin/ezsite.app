...
return [
    ...
    // NOT env('FILESYSTEM_DISK') as the fallback (Curator's own default):
    // that is 'local' here, a private disk with no servable URL. Media must
    // live on a disk that is both tenant-suffixed (tenancy.filesystem.disks)
    // and URL-overridden (tenancy.filesystem.url_override).
