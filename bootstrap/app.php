...
use App\Exceptions\RenderComingSoon;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        // A tenant site with nothing published says "coming soon" rather
        // than 404 — the why and the scoping rules live on the class.
        $exceptions->render(new RenderComingSoon);
    })->create();
